<template>
  ...
  <nav class="mb-1 flex bg-slate-100 p-6 text-3xl font-bold dark:bg-neutral-900">
    {{ viewName }}
    <svg @click="settings = true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="absolute right-5 size-8 self-center">
  ...
  <div :class="settings ? 'translate-x-0' : 'translate-x-full'" class="fixed right-0 top-0 h-full w-[82%] md:w-[36%] lg:w-[30%] xl:w-[28%] 2xl:w-[20%] 3xl:w-[16%] bg-slate-100 shadow-lg transition-transform duration-300 dark:bg-neutral-800">
    <!-- Contenuto del menu -->
