<template>
  <div @click="editNote" class="tracking-tigh w-full rounded-2xl bg-white p-4 pb-3 pt-3 min-h-24 md:min-h-32 lg:min-h-44 dark:bg-neutral-800" @touchstart="startTouch" @touchmove="moveTouch" @touchend="endTouch">
