<template>
  <div @click="editNote" class="tracking-tigh relative w-full rounded-2xl bg-white p-4 pb-3 pt-3  dark:bg-neutral-800" :class="tag.length === 0 ? 'min-h-[70px] md:min-h-[90px] lg:min-h-[110px]' : 'min-h-[114px] md:min-h-[134px] lg:min-h-[154px]'" @touchstart="startTouch" @touchmove="moveTouch" @touchend="endTouch">
    ...
    <!-- Text -->
    <p class="line-clamp-1 pr-6 text-lg/5 text-neutral-500 md:line-clamp-2 lg:line-clamp-3">{{ content }}</p>
