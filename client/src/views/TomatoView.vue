<template>
  <div class="flex min-h-screen flex-col">
    <Navbar viewTitle="Pomodoro" :titleColor="classColor" name="Nome" surname="Cognome" :backButton="true" :settingsArray="settingsArray"></Navbar>
  </div>
</template>
...
export default {
  ...
  setup() {
    ...
    const list = [...store.topItem, ...store.bottomItems].filter(item => item.title === "Pomodoro")
