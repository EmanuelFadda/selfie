<template>
  <div class="flex min-h-screen flex-col">
    <Navbar viewTitle="Note" :titleColor="classColor" titleColor="text-amber-400" name="Nome" surname="Cognome" :backButton="true" :settingsArray="settingsArray"></Navbar>
  </div>
</template>
...
export default {
  ...
  setup() {
    ...
    const list = [...store.topItem, ...store.bottomItems].filter(item => item.title === "Note")
